...
console.log("Testing page count",pages);
...
var sequel = `${title} 2`
console.log("Testing sequel", sequel);
...
console.log("Testing if Short Story", isShortStory);
...
var books = ["The Hobbit", "The Hobbit 2", "The Hobbit 3, Now a Major Motion Picture", "Cradle 2 the Grave", "Ladle 2 the Grave"]
...
var belowTwoHundred = [100, 50, 25, 52, 43, 34, 23, 22, 27, 25, 145, 199]
